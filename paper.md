...
All validation datasets use publicly available SRA data and are distributed with the software as reproducible examples, enabling users to verify installation and understand expected outputs before analyzing their own passage experiments.
