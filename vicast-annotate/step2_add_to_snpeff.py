...
After successful addition:
  You can use the genome for annotation:
    ...
    if success:
        ...
        print(f"  python3 step3_add_to_known_viruses.py {args.genome_id} {args.tsv_file} \\")
        print(f"    --name \"Virus Name\" --family virus_family")
        print("\nThis allows vicast-analyze to generate individual protein sequences")
        print("from consensus genomes (not just full polyprotein).")
        print("="*60)
    else:
        print("\n" + "="*60)
        print("FAILED")
