...
After successful completion:
  snpeff influenza_h1n1_2009 variants.vcf > annotated.vcf
    ...
    if success:
        ...
        print(f"  python3 step3_add_to_known_viruses_segmented.py {args.genome_id} \\")
        print(f"    combined_annotations.tsv --name \"Virus Name\" --family virus_family")
        print("\nNOTE: Segmented genomes may not support individual protein consensus")
        print("generation, but this documents the gene structure for reference.")
        print("\n" + "="*60)
    else:
